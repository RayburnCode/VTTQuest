...
fn ProjectCard(project: Project) -> Element {
    rsx! {
        div { class: "border border-gray-200 bg-text dark:border-gray-700 rounded-lg p-6 hover:shadow-lg transition-shadow",
            h3 { class: "text-xl text-background font-semibold mb-2", "{project.title}" }
...
fn ProjectCard3D(project: Project) -> Element {
    ...
    rsx! {
        div { class: "border border-gray-200 bg-text dark:border-gray-700 rounded-lg overflow-hidden hover:shadow-lg transition-shadow",
            img {
